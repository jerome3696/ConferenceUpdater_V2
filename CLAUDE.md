...
- Phase 1 진행중 / 다음: Step 1.1 마무리 (git 초기 커밋 및 dev 서버 확인)
- 알려진 이슈: 없음
...
- 프롬프트 변경은 src/utils/promptBuilder.js만 수정
- API 호출 로직은 src/services/claudeApi.js
- pass/검색 판단 로직은 src/services/updateLogic.js
- 이 세 파일의 JSON 응답 구조가 서로 맞아야 함 — 하나를 바꾸면 나머지도 확인할 것
