...
- **단계**: dev-guide v3 §A.3 라이브러리·운영 기반 **진행 중**. A.0~A.2 완료.
- **다음**: PLAN-030(라이브러리 구현) · PLAN-037(OAuth) · 아래 검증 5건.
...
- A.3 PLAN 대부분 머지 완료 (031·032·033·034·035·036·038·039).
- **active**: PLAN-030 (라이브러리, 구현 대기) · PLAN-037 (OAuth, 기획).
