...
| PLAN-030 | 라이브러리 스키마+구독+옵트인 동기화 §1.5·§2.4 | PLAN-038 | 🔵 active — S1·S2(적용 완료)·S3·S4 완료, S5~S8 대기 |
...
1. **PLAN-030 라이브러리** — S2 migration 완료(커밋)·S3·S4(온보딩) 완료. S5~S8(UI·테스트) 진행 중. 마이그레이션 적용은 사용자.
