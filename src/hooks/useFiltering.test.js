...
const ROWS = [
  { id: 1, full_name: 'Thermal Conf', abbreviation: 'TEC', category: 'heat', field: 'HT', region: 'Asia' },
  { id: 2, full_name: 'Fluid Dynamics', abbreviation: 'FD', category: 'fluid', field: 'FM', region: 'EU' },
  { id: 3, full_name: 'HVAC Intl', abbreviation: 'HVAC', category: 'heat', field: 'HT', region: 'NA' },
];
...
describe('useFiltering', () => {
  it('초기 상태: 모든 행 pass + 빈 필터', () => {
    ...
    expect(result.current.filters).toEqual({ category: '', field: '', region: '', query: '' });
  });
  ...
  it('null/undefined 필드 값은 options 에서 제외', () => {
    const rowsWithGaps = [
      ...ROWS,
      { id: 4, full_name: 'Edge', abbreviation: 'E', category: null, field: undefined, region: '' },
    ];
